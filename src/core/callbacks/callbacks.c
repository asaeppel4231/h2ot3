...
void callbacks_init(callback_funcs_t* funcs){
    SET_MERRNO_AND_RETURN_VOID_IF_COND_FAILED(funcs != NULL, MERRNO_EC_ISNULL, 0); /* TODO: Use another token*/
...
void callbacks_call_create_func(callback_funcs_t* funcs, void* data){
    SET_MERRNO_AND_RETURN_VOID_IF_COND_FAILED(funcs != NULL, MERRNO_EC_ISNULL, 0); /* TODO: Use another token*/
    SET_MERRNO_AND_RETURN_VOID_IF_COND_FAILED(_internal_callbacks_get_create_func(funcs) != NULL, MERRNO_EC_ISNULL, 0); /* TODO: Use another token*/
    _internal_callbacks_call_create_func(funcs, data);
}

void callbacks_call_destroy_func(callback_funcs_t* funcs, void* data){
    SET_MERRNO_AND_RETURN_VOID_IF_COND_FAILED(funcs != NULL, MERRNO_EC_ISNULL, 0); /* TODO: Use another token*/
    SET_MERRNO_AND_RETURN_VOID_IF_COND_FAILED(_internal_callbacks_get_destroy_func(funcs) != NULL, MERRNO_EC_ISNULL, 0); /* TODO: Use another token*/
    _internal_callbacks_call_destroy_func(funcs, data);
}

void callbacks_call_draw_func(callback_funcs_t* funcs, void* data){
    SET_MERRNO_AND_RETURN_VOID_IF_COND_FAILED(funcs != NULL, MERRNO_EC_ISNULL, 0); /* TODO: Use another token*/
    SET_MERRNO_AND_RETURN_VOID_IF_COND_FAILED(_internal_callbacks_get_draw_func(funcs) != NULL, MERRNO_EC_ISNULL, 0); /* TODO: Use another token*/
